...
| Extraction Review | **구현** | 한 번에 한 fact를 좌우 이동하며 raw field·locator·quote를 확인하고 승인/제외. 유효한 추천이 없으면 `확인하고 다음`으로 안전하게 판정 입력에서 제외. 13개 normalized fact와 EVENT_STATE snapshot 구조화 편집 |
